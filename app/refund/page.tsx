        ...
        <div className="card p-8 space-y-8">
            ...
            <div className="space-y-4 text-gray-700">
              <div>
                ...
                <ul className="list-disc list-inside space-y-2 ml-4">
                  ...
                  <li>
                    ...
                    (단, 고객의 입력 실수인 경우 1회에 한하여 재분석 제공)
                  </li>
                  <li>
              ...
              <div>
                ...
                <ul className="list-disc list-inside space-y-2 ml-4">
                  ...
                  <li>
                    분석 결과에 대한 만족도 또는 주관적 판단에 의한 취소
                  </li>
                  <li>
                    결제 후 7일이 경과한 경우
                  </li>
              ...
              <div className="border-l-4 border-primary-500 pl-4 bg-gray-50 p-4 rounded">
                ...
                <ul className="text-sm space-y-1">
                  <li>• 신용카드: 승인 취소 후 3-5 영업일 내 환불</li>
          ...
          <section>
            ...
            <div className="space-y-4 text-gray-700">
              ...
              <div>
                <h3 className="font-semibold mb-2">재분석 제공 가능한 경우</h3>
                <ul className="list-disc list-inside space-y-2 ml-4">
                  <li>
                    이용자의 입력 오류로 인한 잘못된 분석 (1회 한정)
                  </li>
                  <li>
                    시스템 오류로 인한 부정확한 분석
                  </li>
              ...
              <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                ...
                <ol className="text-sm text-yellow-800 space-y-1 list-decimal list-inside ml-4">
                  <li>고객센터로 재분석 신청 (이메일 또는 문의하기)</li>
                  <li>주문번호 및 사유 기재</li>
                  <li>담당자 확인 후 1-2 영업일 내 처리</li>
                </ol>
              </div>
            </div>
          </section>
          ...
          {/* 제3조 */}
          <section>
            <h2 className="text-xl font-bold mb-4">제3조 (환불 신청 절차)</h2>
            <div className="space-y-4 text-gray-700">
          ...
          <section>
            ...
            <div className="space-y-3 text-gray-700">
              <p>
                여러 상품을 한 번에 구매한 경우, 일부 상품에 대해서만 환불을 원하는
                경우:
              </p>
              <ul className="list-disc list-inside space-y-2 ml-4">
                <li>
                ...
                <li>
                  할인 혜택이 적용된 경우, 환불 시 할인율이 재조정될 수 있음
                </li>
              </ul>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="space-y-3 text-gray-700">
              <ol className="list-decimal list-inside space-y-2 ml-4">
                ...
                <li>
                  회사와 이용자 간 협의가 이루어지지 않은 경우, 전자상거래
                  분쟁조정위원회 또는 소비자보호원에 중재를 신청할 수 있습니다.
                </li>
                <li>
                  분쟁조정 신청:
